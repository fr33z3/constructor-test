...
Begun.Scripts.importAllScripts({"acp/begun_utils.454f917bf1.js":true});
...
"auto_hyper":"d032d25649",
"auto_photo":"1878df0a24",
"auto_turnoff":"18e44be271",
"toolbar":"1b87a3787a",
"auto_zoom_slider":"b7d305733a",
"catalog_tree":"f37944542d",
"auto_mediatext":"4bb9cb82c2"
};
...
}else if(_this.isRichMini(block)||_this.isPriceOffer(block)){
...
"begun_tpl_block_200x300":"4d8a5abbd1",
"begun_tpl_block_mediatext_200x300":"9218db4ae9",
"begun_tpl_block_240x400":"c93e27ef23",
"begun_tpl_block_240x400_custom":"4fd34f6a5a",
"begun_tpl_block_price_240x400":"0de4d69f14",
"begun_tpl_block_mediatext_240x400":"02435cf4be",
"begun_tpl_block_300x250":"400c6d670e",
"begun_tpl_block_mediatext_300x250":"8a6ca6b003",
"begun_tpl_block_468x60":"ace4fdd537",
"begun_tpl_block_728x90":"11a46f23b7",
"begun_tpl_block_728x90_custom":"e6371c8aa5",
"begun_tpl_block_price_728x90":"3b7e1106b6",
"begun_tpl_block_990x90":"656dc8074b",
"begun_tpl_block_flat":"b1eead6451",
"begun_tpl_block_horizontal":"071abb63ed",
"begun_tpl_block_price_horizontal":"f6b14cb523",
"begun_tpl_block_square":"a8e272ca20",
"begun_tpl_block_top":"49b37c7c3b",
"begun_tpl_block_vertical":"4c1b95d6b0",
"begun_tpl_block_price_vertical":"b2a616d3f6",
"begun_tpl_block_price_composite":"05d09e5853",
"begun_tpl_block_price_search":"02403271f4",
"begun_tpl_block_price_services_vertical":"a0fc7e58da",
"begun_tpl_block_mobile":"15770afbfe",
"begun_tpl_block_eda":"1bfda6ef17"
};
...
price:protocol+'//price.ru/?utm_source=partner&utm_medium=logo&utm_campaign=goods_blocks',
...
var blockEl=_this.Blocks.getDomObj(window.begun_block_id);
...
var url=Begun.Scripts.getConformProtocol()+"//profile.begun.ru/sandbox?"+linksArr.join('&'),
linksFrame=document.createElement("iframe");
linksFrame.setAttribute("style","height:0;width:0;border:0");
var iframe=Begun.$$('head',document,0).appendChild(linksFrame),
iframeDocument=iframe.contentWindow.document;
iframeDocument.open().write('<body onload="location.href=\''+encodeURI(url)+'\'">');
...
var isRich,isHyper,isCatalog,isPhoto,isTurnoff,isMediaText,
blocks=feed.blocks;
for(var k=0;k<blocks.length;k++){
if(_this.Blocks.checkTypeContains(blocks[k],'mediatext')){
isMediaText=true;
}
...
if(html&&block_place){
if(logo_display){
html=_this.insertGraphLogo(html,block_place,size.width);
}
...
var graph_logo_html=(new Begun.Template(_this.Tpls.getHTML('graph_begun_logo'))).evaluate({begun_logo:_this.Strings.urls.begun}),
...
options.dimensions.type='horizontal';
}
...
title:banner.title,
descr:banner.descr,
price:banner.bottom?banner.bottom+" <i>ð.</i>":banner.bottom,
url:banner.url
};
...
if(bannerType=='banner_price_composite_rich'){
vars.picture=(new Begun.Template(_this.Tpls.getHTML('bnnr_picture'))).evaluate({src:pictures.big,big_photo_src:pictures.big,url:banner.url});
}
...
var indirectRichBanner=_this.getBanner('autocontext',0);
...
banner.view_type='Offer';
offerBanners.push(banner);
}
var offerBannersLength=offerBanners.length,
offerBanner,
offerBannersHTML=[],
...
for(j=0;j<offerBannersLength&&j<bannersCount;j++){
...
vars.hide_only_offers='display:none !important;';
}
}else{
...
this.isPriceOffer=function(block){
